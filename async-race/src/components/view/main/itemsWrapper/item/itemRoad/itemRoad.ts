...
export class ItemBtnWrapper extends View {
  ...
  private changeView(): void {
    this.itemBtnStart = new ItemBtnStart({ tag: 'button', classNames: ['item__btn', 'start'], innerText: 'START' });
    this.itemBtnStop = new ItemBtnStop({ tag: 'button', classNames: ['item__btn', 'stop'], innerText: 'STOP' });
...
export class Item extends View {
  ...
  setColor(color: string): void {
    this.view.getElement().innerHTML = `<?xml version="1.0" standalone="no"?>
    <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
     "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd">
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
     width="100px" height="75.46px" viewBox="0 0 1280.000000 966.000000"
...
export class ItemRoad extends View {
  ...
  private changeView(): void {
    ...
    this.itemTrack = new ItemTrack({ classNames: ['item__track'] });
